		...
		<div class="col-md-12">
			<div class="mo_firebase_auth_card" style="width:100%">
				<form name="integration_form" id="mo_firebase_auth_integration"  method="post">
					...
					<label for="mo_firebase_hide_password_field" style="font-size: 15px">Hide change password field in WooCommerce and WordPress user admin dashboard </label><br>
					<input type="checkbox" disabled id="mo_firebase_sync_existing_user" name="mo_firebase_sync_existing_user" value="1">
					<label for="mo_firebase_sync_existing_user" style="font-size: 15px">Sync existing user</label>
					<div class="mo-firebase-auth-tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i><div class="mo-firebase-auth-tooltip-text mo-tt-right">Whenever non-Firebase users log into your site, this checkbox will synchronize the user in Firebase.</div> </div>
					<br><br> 
				</form>
			</div>
		</div>
