		...
		<div class="col-md-12">
			<div class="mo_firebase_auth_card" style="width:100%">
				...
				<form name="f" method="post" action="">
					...
					<div class="row">
						<div class="col-md-6">
							<p style="margin-bottom: 3px"><b>Redirect URL if email is not verified </b></p>
						</div>
						<div class="col-md-6">
						<input name="custom_after_logout_url" value="" pattern="https?://.+" title="Include https://" placeholder="https://" style="width:80%; font-size: 14px;" type="url" disabled="">
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<p style="margin-bottom: 3px"><b>Redirect URL if Oob code is invalid </b></p>
						</div>
						<div class="col-md-6">
						<input name="custom_after_logout_url" value="" pattern="https?://.+" title="Include https://" placeholder="https://" style="width:80%; font-size: 14px;" type="url" disabled="">
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<p style="margin-bottom: 3px"><b>Error message to be displayed if user email is not verified</b></p>
						</div>
						<div class="col-md-6">
							<input name="error_message_if_email_not_verified" value="" placeholder="Your email is not verified. Please verify your email"style="width:80%;" type="text" disabled="">
						</div>
					</div><br/>
					<br>
					<div class="row">
						<div class="col-md-6">
							<p style="margin-bottom: 3px"><b>Set cookies for the domain</b></p>
							<p>This will set Firebase JWT of the user in the<b> mo_firebase_jwt_cookie </b></p>
						</div>
						<div class="col-md-6">
							<input name="set_cookie_for_domain" value=""placeholder=".<?php echo esc_attr( $host ); ?>"style="width:80%;" type="text" disabled="">
						</div>
					</div>
					<br>
					<div class="row">
