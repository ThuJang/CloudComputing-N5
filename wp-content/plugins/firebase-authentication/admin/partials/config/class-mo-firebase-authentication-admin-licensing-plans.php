		...
		?>
			...
			<div style="    width: 86%;margin: 0 auto;">
				<div class="row">
					...
					<br/><br/>
					<div style="margin: 0 20px;"><b style="color: red">*</b><strong>Cost applicable for one instance only. The WordPress Firebase Autentication plugin licenses are subscription-based, and each license includes 12 months of maintenance, which covers version updates .</strong></div>
